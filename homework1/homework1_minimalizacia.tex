...
S využitím \textit{Algoritmu 3.5}~\cite{TIN}(str. č. 34) minimalizujme predošlý automat:
...
Premenujeme si jednotlivé stavy automatu ktoré znázorňujú jednotlivé ekvivalenčné triedy:
\begin{center}
...
Znovu zakreslíme automat s premenovanými stavmi:
